                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ route('client_status_put') }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" id="status" name="status">
                                                <option value="pending"
                                                    {{ old('status') == 'pending' ? 'selected' : ($client->status == 'pending' ? 'selected' : '') }}>
                                                    Pending</option>
                                                <option value="completed"
                                                    {{ old('status') == 'completed' ? 'selected' : ($client->status == 'completed' ? 'selected' : '') }}>Completed
                                                </option>
                                                <option value="no_show"
                                                    {{ old('status') == 'no_show' ? 'selected' : ($client->status == 'no_show' ? 'selected' : '') }}>No Show</option>
                                            </select>
                                        </div>
                                        @if ($errors->any())
                                            <div class="form-group">
