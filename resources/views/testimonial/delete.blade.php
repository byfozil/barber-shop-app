                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Delete Testimonial</h4>
                                    <form class="forms-sample" action="{{ route('testimonial_delete_delete') }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        @endif
                                        <button type="submit" class="btn btn-primary me-2">Delete Testimonial</button>
