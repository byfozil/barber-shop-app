                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Edit Barber</h4>
                                    <form class="forms-sample" action="{{ route('barber_edit_put') }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="id" value="{{ old('id') ? old('id') : $barber->id }}">
                                        <div class="form-group">
                                            <label for="name">Name</label>
                                            <input type="text" class="form-control" id="name" name="name"
                                                placeholder="Name"
                                                value="{{ old('name') ? old('name') : $barber->name }}">
                                        </div>
                                        @if ($errors->any())
                                            <div class="form-group">
                                        ...
                                        @endif
                                        <button type="submit" class="btn btn-primary me-2">Edit Barber</button>
                                        <a href="../../barbers" class="btn btn-dark">Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
