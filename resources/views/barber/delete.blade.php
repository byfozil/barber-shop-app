                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Delete Barber</h4>
                                    <form class="forms-sample" action="{{ route('barber_delete_delete') }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <input type="hidden" name="id"
                                            value="{{ old('id') ? old('id') : $barber->id }}">
                                        @if ($errors->any())
                                            <div class="form-group">
                                                <p class="text-danger">{{ $errors->first() }}</p>
                                            </div>
                                        @endif
                                        <button type="submit" class="btn btn-primary me-2">Delete Barber</button>
